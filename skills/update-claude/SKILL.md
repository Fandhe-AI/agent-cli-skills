...
```bash
# implement-issue-tree スキルから workflow js を取得する場合
# .claude/skills/implement-issue-tree/script/ 配下を確認
ls <target-repo>/.claude/skills/implement-issue-tree/script/ 2>/dev/null

# workflow js を配置
mkdir -p <target-repo>/.claude/workflows/
cp <target-repo>/.claude/skills/implement-issue-tree/script/implement-issue-tree.js \
