...
| 公式外部ドキュメント（Claude Code / gh / GitHub API） | ✅ WebFetch/WebSearch |
| ファイルの作成・編集・削除 | ❌ 禁止 |
...
選定した URL を WebFetch で取得し、トピックに関連する節を抽出する。ページが大きい場合は目次から該当節へのアンカーを辿る。
...
- [ ] リポ内の関連ドキュメントを確認した
- [ ] 公式ドキュメント（少なくとも1件）を WebFetch で取得した
